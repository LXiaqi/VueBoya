  ...
  <div class="warp">
    <div v-if="stat == 1">
      <el-form ref="form" label-width="110px">
        ...
        <el-form-item>
          <el-button type="primary" @click="charmGradeEdit" 
            >立即修改</el-button
          >
        </el-form-item>
      </el-form>
    ...
    <div v-else class="warp">
        ...
        <el-form-item>
          <el-button type="primary" @click="charmGradeAdd" 
            >立即添加</el-button
          >
        </el-form-item>
      </el-form>
...
<script>
import { charmGradeEdit, charmGradeDetails, charmGradeAdd } from "@/api/grade";
import {
    qiniuToken
} from '@/api/Qiniuyun'
export default {
  ...
  methods: {
    info() {
      charmGradeDetails(this).then((res) => {
        this.form = res.data;
      });
      // 获取七牛云token
